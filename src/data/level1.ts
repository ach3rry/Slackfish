...
export const LEVEL_AREAS: Record<string, AreaConfig> = {
  ...
  corridor: {
    id: 'corridor', name: '中央走廊', label: '中央走廊',
...
export const LEVEL_ACTIONS: ActionConfig[] = [
  { id: 'working', name: '正常工作', icon: '💻', area: 'workstation', fishPerSecond: 0, salaryPerSecond: 2, risk: 'none', description: '无摸鱼收益，工资 +2/秒' },
  ...
  { id: 'fakeWorking', name: '假装办公', icon: '🧑‍💻', area: 'pantry', fishPerSecond: 4, salaryPerSecond: 0, risk: 'medium', disguise: true, description: '摸鱼收益 +4/秒，伪装中' },
  { id: 'phone', name: '刷手机', icon: '📱', area: 'restroom', fishPerSecond: 5, salaryPerSecond: 0, risk: 'zero', description: '摸鱼收益 +5/秒，绝对安全' },
]
...
export const BOSS_ROUTE: Point[] = [
  { x: 454, y: 190 }, { x: 520, y: 316 }, { x: 252, y: 404 },
  { x: 520, y: 316 }, { x: 826, y: 330 }, { x: 540, y: 246 }, { x: 454, y: 132 },
]
